...
```{r compute interval means and standard deviations BIAD}
...
```{r compute steps per day on imputed data}
...
```{r plot activity for weekdays and weekends}
Hour = (0:287)*5/60
